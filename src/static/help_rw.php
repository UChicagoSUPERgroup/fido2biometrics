...
?>
        <div class="container">
            ...
            <div class="row">
                ...
                <p>
                <?php echo 'Your device must be capable of biometric authentication. If you use fingerprint or face recognition, or another similar method to unlock your device, then it is capable of biometric authentication. If you still cannot successfully register an account, <a onclick="logEvent(\'clicked()->MoreHelp->early\');" href="https://example.tech/static/exit.php?d1='.urlencode(Base64Url::encode($_SESSION['prolific'])).'&d2='.urlencode(Base64Url::encode('early')).'&d3='.urlencode(Base64Url::encode($_SESSION['notification'])).'" target="_blank">click here to exit the survey</a> early.'; ?>
                </p>
                </div>
            </div>
        </div>
